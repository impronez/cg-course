...
public class GameViewModel
{
    ...
    public readonly TileViewModel[] TileViewModels;
    ...
    public GameViewModel(GameModel gameModel)
    {
        ...
        TileViewModels = new TileViewModel[gameModel.Field.Tiles.Length];
    }
    ...
    private void InitializeTileViewModels()
    {
        ...
        for (int i = 0; i < _gameModel.Field.Tiles.GetLength(0); i++)
        {
            for (int j = 0; j < _gameModel.Field.Tiles.GetLength(1); j++)
            {
                ...
                TileViewModels[index++] = new TileViewModel(tile, new Vector3(i - offsetX, j - offsetY, 0f));
            }
        }
    }
}